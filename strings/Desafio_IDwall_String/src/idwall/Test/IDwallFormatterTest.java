...
"there was morning - the first day.";
	...
	final String INPUT = "hello world, we need to solve the challenge and deliver on time.";
	final String OUTPUT = "hello world, we need to solve the\n" +
						"challenge and deliver on time.";
	
	@Test
	public void testFormatP1() {
		final StringFormatter sf = new IdwallFormatter();
        String textFormatted = sf.format(INPUT_TEXT);                
